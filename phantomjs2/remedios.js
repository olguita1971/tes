                ...
                try {
												...
												if(ignoreIds.indexOf(results.get(i).id) < 0 ){
													if(origins.indexOf(results.get(i).origCity.split('.').join('').toLowerCase())>-1){
														if(destinations.indexOf(results.get(i).destCity.split('.').join('').toLowerCase())>-1){
															...
															print("Load " + results.get(i).id + " " + results.get(i).destCity );
														}
													}else{
														print("Load " + results.get(i).id + " " + results.get(i).origCity );
													}
												}else{
                    ...
                    if (found) {
                        ...
                        $.ajax({
                            ...
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            url: "https://carsarrive-remedios.firebaseio.com/loads/" + now() + "/.json",
